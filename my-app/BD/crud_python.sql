...
-- Volcando estructura de base de datos para usuario_python_flask
CREATE DATABASE IF NOT EXISTS `usuario_python_flask` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `usuario_python_flask`;

-- Volcando estructura para tabla usuario_python_flask.tbl_empleados
...
-- Volcando datos para la tabla usuario_python_flask.users: ~2 rows (aproximadamente)
INSERT INTO `users` (`id`, `name_surname`, `email_user`, `pass_user`, `created_user`) VALUES
	(1, 'Raul', 'dev@gmail.com', 'scrypt:32768:8:1$ZXqvqovbXYQZdrAB$66758083429739f4f8985992b22cb89fb58c04b99010858e7fb26f73078a23dd3e16019a17bf881108d582a91a635d2c21d26d80da1612c2d9c9bbb9b06452dc', '2023-07-21 20:10:01'),
